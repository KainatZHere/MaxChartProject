...
const FavouriteModule = () => {
  ...
  const [emailId, setEmailId] = useState(470491);
  ...
  const getFavEmailsData = async () => {
    setLoading(true);
    const resp = await fetch(
      `http://tfs-dgk:8784/api/Email/GetEmailsList?UserId=70044&PageNumber=1&Rows=1000&isFav=true`,
      {
        method: "GET",
        headers: {
